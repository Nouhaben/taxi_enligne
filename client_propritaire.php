							...
							<!-- Sidebar -->
								<section id="sidebar">
									<section>
										...
										<p>VOTRE COMPTE SERA AUTOMATIQUEMENT 
											CRÉÉ LORS DE VOTRE PREMIÈRE 
											COMMANDE DE TAXI*</p>
										<ul class="actions">
											<li><a href="commandez_taxi.php" class="button">Commandez un taxi</a></li>
										</ul>
									</section>
                ...
                <div id="container_demo" >
                    ...
                    <div id="wrapper">
                        ...
                        <div id="register" class="animate form">
                            <form action="traitement_inscription.php"autocomplete="on" method="post"> 
                                <h1> Insciption </h1> 
                                
								<p> 
                                    <label for="emailsignup" class="youmail"> Nom : </label>
                                    <input id="nomsignup" name="nom" required="required" type="text" placeholder=""/> 
                                </p>
								
								<p> 
                                    <label for="emailsignup" class="youmail"> Prénom :</label>
                                    <input id="prenomsignup" name="prenom" required="required" type="text" placeholder=""/> 
                                </p>
								
								<p> 
                                    <label for="emailsignup" class="youmail"> Portable :</label>
                                    <input id="portablesignup" name="portable" required="required" type="text" placeholder=""/> 
                                </p>
								...
								<p>
                                    <label for="emailsignup" class="youmail"> Genre :</label>
                                    <select id="genresignup" name="genre" required="required">
										<option>Femme</option>
										<option>Homme</option>
									</select>
                                </p>
                                ...
                                <p> 
                                    ...
                                    <input id="passwordsignup_confirm" name="password_confirm" required="required" type="password" placeholder=""/>
                                </p>
                                ...
                                <p class="change_link">  
									Déja membre ?
									<a class="to_register"> Créer mon compte </a>
								</p>
