			...
			<div id="header-wrapper">
				...
				<!-- Header -->
					<div id="header" class="container">
						...
						<!-- Logo -->
							<h1 id="logo"><a href="index.html" class="fa fa-home active">Taxi EnLigne</a></h1>
						
						<!-- Nav -->
							<nav id="nav">
								<ul>
									<li>
										<a href="commandez_taxi.html">Commandez un Taxi</a>
										<!-- <ul>
									...
									<li><a href="client_propritaire.html">Devenez Client prioritaire </a></li>
									<li class="break"><a href="espace_chauffeur.html">Espace Chauffeur</a></li>
									<li><a href="taxi_dispo.html">Taxis disponibles</a></li>
								</ul>
							</nav>
